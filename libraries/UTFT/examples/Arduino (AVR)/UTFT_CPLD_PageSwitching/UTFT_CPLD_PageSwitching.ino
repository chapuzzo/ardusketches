...
//UTFT myGLCD(EHOUSE50CPLD,19,18,17,16);   // Remember to change the model parameter to suit your display module!

// Uncomment the next line for Arduino Mega
UTFT myGLCD(EHOUSE50CPLD,38,39,40,41);   // Remember to change the model parameter to suit your display module!
