...
/Some examples require pre-loaded images or text files!

/**************************************************************/
Be sure to place first the SMARTGPU library, the entire folder(SMARTGPU)
...
be sure to check out all the SMARTGPU examples 100% ready to compile
/**************************************************************/
