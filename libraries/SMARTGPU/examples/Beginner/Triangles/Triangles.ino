...
void loop() { //main loop draw random colour and size triangles
    ...
    while(1){//forever
      ...
      x3=random(0,319);              //get a random number 0-319
      y3=random(0,239);              //get a random number 0-239       
      colour=random(0,65536);        //get a random number 0-65535
      fill=random(0,2);              //get a random number 0-1      
      
      //draw the triangle
      lcd.drawTriangle(x1,y1,x2,y2,x3,y3,colour,fill); //draw random triangles
    }
}
